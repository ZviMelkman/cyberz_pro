---
layout: post
title: "You Got CMMC Level 2 Certified. Now What?"
date: 2026-09-16
description: "1,391 companies held a Final CMMC Level 2 certificate by May 2026. On September 3 the requirement to have one was struck from new DoD contracts. What the certificate is still worth under 32 CFR 170.17 and DFARS 252.204-7021, which clocks keep running, and what the contractors who paused should do instead."
category: CMMC
tags: [CMMC, CMMC Level 2, C3PAO, certification validity, 32 CFR 170.17, DFARS 252.204-7021, annual affirmation, SPRS, Phase 2 suspension, defense contractors]
image: /blog/images/1-cmmc-level-2-certified-now-what-hero.png
author: CyberZ
---
...
<li>Cyber AB reported 1,391 Final Level 2 certificates issued as of its May 2026 town hall. Nothing in the July 13 suspension memos or the September 3 class deviation cancels one. A certificate is valid for three years from the CMMC Status Date under 32 CFR 170.17.</li>
<li>DFARS 252.204-7021(d)(1)(i) requires the designated level "or higher." A Level 2 (C3PAO) status therefore covers any Level 2 (Self) or Level 1 (Self) requirement that appears in a solicitation during the suspension. You do not redo the self-assessment.</li>
<li>Three clocks did not stop: the three-year certification cycle, the annual affirmation under 32 CFR 170.22 and 7021(d)(3), and the six-year hashed-artifact retention under 32 CFR 170.17. Miss the affirmation and the certificate stops earning you eligibility.</li>
<li>Primes were never bound by the suspension. DFARS 252.204-7021(f) requires them to flow the substance of the clause down, and several kept Level 2 (C3PAO) in their subcontract terms. Your certificate answers that demand; a paused assessment does not.</li>
<li>If you pulled out of the queue, you are not on hold. Level 2 (Self) remains the codified default, the SPRS score is a representation to the government, and DOJ collected $507,144 from LOGZONE in June over a self-assessment score an audit found inaccurate.</li>
</ul>
</div>
...
If the immediate job is proving the certificate is still defensible, the [CMMC Level 2 Evidence Tracker for NIST 800-171 Audit](https://payhip.com/b/LN2UB) ($67) maps every artifact to its requirement and assessment objective so the six-year retention has a structure. If you paused the assessment and need to run the full self-assessment regime properly before an affirmation deadline or a prime's demand forces the timeline, the [CMMC Level 2 Readiness Kit: 5 NIST 800-171 Tools](https://payhip.com/b/LutGC) ($147) covers scoping, the SSP, the SPRS score, the POA&M, and the evidence trail a DIBCAC assessor or a DOJ attorney would ask for.

## Sources

- 32 CFR 170.17, CMMC Level 2 certification assessment and affirmation requirements (three-year validity, six-year hashed artifact retention, DIBCAC precedence over pre-existing status)
- 32 CFR 170.21, Plan of Action and Milestones requirements (180-day closeout); 32 CFR 170.22, affirmation; 32 CFR 170.23, flowdown
- DFARS 252.204-7021, Contractor Compliance with the Cybersecurity Maturity Model Certification Level Requirements, paragraphs (d)(1)(i), (d)(3), and (f)
- U.S. Department of War, DARS class deviation 2026-O0025, Revision 3, signed September 3, 2026; original 2026-O0025 effective February 1, 2026 (DFARS Part 240, 252.240-7997)
- U.S. Department of War, CIO and USD(A&S) memoranda suspending CMMC Phase 2, July 13, 2026
- Federal News Network, "As the Pentagon rethinks CMMC, cybersecurity isn't pausing," interview with Stephanie Kostro, Professional Services Council, September 15, 2026
- Cyber AB, May 2026 town hall (1,391 Final Level 2 certificates issued), as reported by Government Contracts Law, July 15, 2026
- Matthew Travis, Cyber AB, remarks on Level 2 certification as reported by Secureframe, July 21, 2026
- U.S. Department of Justice, press releases: LOGZONE Inc. False Claims Act settlement ($507,144), June 2026; Honeywell Aerospace False Claims Act settlement ($2,042,518), September 1, 2026
- NIST SP 800-171 Rev 2; DoD Assessment Methodology for NIST SP 800-171
