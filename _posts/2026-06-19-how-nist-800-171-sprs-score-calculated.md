...
## What Is the SPRS Score, and Where Does It Live?
...
You start at 110 and subtract a weighted penalty for every NIST SP 800-171 control you have not fully implemented. Each control is worth 1, 3, or 5 points under the DoD Assessment Methodology, with no partial credit. The result is your score, on a scale that runs from 110 down to minus 203.

### What is a good SPRS score?

The honest one. For CMMC Level 2, 88 of 110 is the threshold for a conditional certification (about 80 percent of the controls), and 110 is full implementation. A higher number helps you compete, but an inflated number is a False Claims Act risk, so accuracy matters more than the figure itself.

### What is the lowest possible SPRS score?

Minus 203. The total weighted value of all 110 controls exceeds 110, so a contractor that has implemented few of the high-weight controls can fall well below zero.

### Can your SPRS score be negative?

Yes, and it is common on a first honest assessment. Missing several 5-point controls, such as multi-factor authentication or FIPS-validated encryption, drives the number negative quickly. A negative score signals work to do, not a calculation error.

### Are SPRS scores public?

No. The Supplier Performance Risk System is a restricted Department of Defense system. Your score is visible to authorized government users, including contracting officers, and to your own organization, not to the general public.

### How do I get and submit an SPRS score?

Assess your environment against the DoD NIST SP 800-171 Assessment Methodology, calculate the weighted score, and enter it in the Supplier Performance Risk System through the PIEE portal. The score must be current, meaning less than three years old, to be used for award.

### Which DFARS clause requires an SPRS score?

DFARS 252.204-7019 requires you to have a current assessment posted in SPRS, and 252.204-7020 gives the Department of Defense the right to conduct or verify that assessment. Both trace to the DFARS interim rule that took effect in late 2020.

### What is the difference between CMMC and SPRS?

SPRS is the database that holds your self-assessed NIST SP 800-171 score under the DFARS clauses. CMMC is the certification program that, at Level 2, requires you to meet those same NIST SP 800-171 controls and, for many contracts, pass a third-party C3PAO assessment. Your SPRS score is the starting point that CMMC then verifies.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How is the SPRS score calculated?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You start at 110 and subtract a weighted penalty for every NIST SP 800-171 control you have not fully implemented. Each control is worth 1, 3, or 5 points under the DoD Assessment Methodology, with no partial credit. The result is your score, on a scale that runs from 110 down to minus 203."
      }
    },
    {
      "@type": "Question",
      "name": "What is a good SPRS score?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "For CMMC Level 2, 88 of 110 is the threshold for a conditional certification (about 80 percent of the controls), and 110 is full implementation. A higher number helps you compete, but an inflated number is a False Claims Act risk, so an accurate score matters more than the figure itself."
      }
    },
    {
      "@type": "Question",
      "name": "What is the lowest possible SPRS score?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Minus 203. The total weighted value of all 110 controls exceeds 110, so a contractor that has implemented few of the high-weight controls can fall well below zero."
      }
    },
    {
      "@type": "Question",
      "name": "Can your SPRS score be negative?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, and it is common on a first honest assessment. Missing several 5-point controls, such as multi-factor authentication or FIPS-validated encryption, drives the number negative quickly. A negative score signals work to do, not a calculation error."
      }
    },
    {
      "@type": "Question",
      "name": "Are SPRS scores public?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. The Supplier Performance Risk System is a restricted Department of Defense system. Your score is visible to authorized government users, including contracting officers, and to your own organization, not to the general public."
      }
    },
    {
      "@type": "Question",
      "name": "How do I get and submit an SPRS score?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Assess your environment against the DoD NIST SP 800-171 Assessment Methodology, calculate the weighted score, and enter it in the Supplier Performance Risk System through the PIEE portal. The score must be current, meaning less than three years old, to be used for award."
      }
    },
    {
      "@type": "Question",
      "name": "Which DFARS clause requires an SPRS score?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "DFARS 252.204-7019 requires you to have a current assessment posted in SPRS, and 252.204-7020 gives the Department of Defense the right to conduct or verify that assessment. Both trace to the DFARS interim rule that took effect in late 2020."
      }
    },
    {
      "@type": "Question",
      "name": "What is the difference between CMMC and SPRS?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "SPRS is the database that holds your self-assessed NIST SP 800-171 score under the DFARS clauses. CMMC is the certification program that, at Level 2, requires you to meet those same NIST SP 800-171 controls and, for many contracts, pass a third-party C3PAO assessment. Your SPRS score is the starting point that CMMC then verifies."
      }
    }
  ]
}
