...
The pressure is real and it has a date on it. CMMC Phase 2 begins November 10, 2026. From that point, a Level 2 certification assessment by a Certified Third-Party Assessment Organization (C3PAO) becomes a condition of award for contracts involving CUI, under the program established in 32 CFR Part 170 and the contract clause rule in 48 CFR. Self-attestation stops being enough for those contracts.
...
CMMC Level 2 gives every contractor the same 110 controls. It does not give every contractor the same amount of work. The variable is scope, and scope is a decision you make at the start, governed by the five asset categories in 32 CFR 170.19. Draw the boundary tight and enforce it, and you are solving a small problem with months to spare before the Phase 2 deadline. Let CUI sprawl, and you are securing your whole company against a closing clock.
...
**Sources:** 32 CFR Part 170, specifically 170.19 (CMMC scoping) and 170.19(c)(1) (Level 2 asset categories); DoD CMMC Scoping Guide, Level 2; NIST SP 800-171; 48 CFR CMMC contract clause rule (Phase 2 effective November 10, 2026). Enclave scope-reduction figures reflect estimates reported by CMMC assessment practitioners.
